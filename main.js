...
function toggleMobileMenu() {
  ...
  /* se llama la funcion closeProductDetailAside()
para cerrar el detalle del producto al pulsar el menu en mobile*/
...
function toggleCarritoAside() {
  ...
  const isProductDetailClosed =
    productDetailContainer.classList.contains("inactve");
